// Separate module: the Solana SDK is heavy and chain-specific, so it stays out of
// the offline core (blockchain-agnostic invariant) — same quarantine as the other
// chain submitters. Solana is non-EVM (ed25519, base58, lamports); the anchor
// rides on-chain via the SPL Memo program.
//
...
require github.com/gagliardetto/solana-go v1.24.0
